  ...
  //Default constructor
   ...
   //All the settings of the variables.
     ...
     //Panel 1 for the title 
      JPanel panel1 = new JPanel(new GridLayout(2,3,4,4));
      panel1.add(title);
     ...
     //Panel7 for the sex RadioButtons
     ...
     //Panel10 is to organize the previous panels into one
      JPanel panel10 = new JPanel(new FlowLayout());
      panel10.add(panel9);
      panel10.add(panel8);
     
     //Panel11 is the buttons
     ...
     //panel12 for all the labels that have undergone calculations from
     ...
     //panel13 for JLabels regarding the information on BMI and other messages related to BMI.
